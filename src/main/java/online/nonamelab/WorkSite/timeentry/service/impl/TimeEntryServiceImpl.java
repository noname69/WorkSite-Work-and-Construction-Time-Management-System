...
public class TimeEntryServiceImpl implements TimeEntryService {
    ...
    private final TimeEntrySiteRepository timeEntryProjectRepository;
    ...
    public TimeEntryServiceImpl(UserRepository userRepository, ConstructionSiteRepository constructionSiteRepository,
                                TimeEntryRepository timeEntryRepository, TimeEntrySiteRepository timeEntryProjectRepository,
    ...
    public TimeEntryResponse createOrGet(CreateTimeEntryRequest request) {
        ...
        // 3. create project
        CreateTimeEntrySiteRequest projectRequest = request.site();
